...
/**
 * GET /api/metrics — Admin-only dashboard metrics.
 * Returns: rewrite rate, corrections/day, graph size, active conversations, usage.
 */
export default async function handler(req, res) {
  ...
  try {
    ...
    // Compute usage totals for last 24h
