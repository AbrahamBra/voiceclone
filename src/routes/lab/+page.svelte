...
<main class="landing">
  ...
  <section class="hero" id="hero">
    <div class="overline mono">
      ◇ pour les agences ghostwriting · branding · growth qui font aussi du setting LinkedIn
    </div>

    <h1 class="headline">
      <span>Plusieurs clients. Plusieurs façons de DM. Un setter qui tient la ligne.</span>
      <span>Votre setter colle le DM d'un prospect.</span>
      <span class="accent">Le draft sort comme <em>votre client</em> l'écrirait.</span>
    </h1>

    <p class="sub">
      Un client = sa façon de faire : règles, ouvertures, cadence, signature.
      Écrites dès l'onboarding. Votre setter tape dedans. Chaque type d'action
      outbound (DM, ajout de contact, interaction de contenu, visite de profil...)
      porte ensuite son playbook agence par-dessus.
    </p>
    ...
    <ul class="triptyque" aria-label="Ce que Setclone fait concrètement">
      <li class="beat">
        ...
        <p class="beat-body">
          ...
          Votre setter tape dedans, pas à côté.
        </p>
      </li>
      <li class="beat">
        <h3 class="beat-title">corrigez une fois, expliquez au clone</h3>
        <p class="beat-body">
          Vous virez un mot, le clone demande <em class="quoted">« pourquoi »</em>.
          La règle rentre avec son contexte. Le setter junior qui arrivera
          plus tard n'y retapera pas deux fois.
        </p>
      </li>
      <li class="beat">
        <h3 class="beat-title">trois garde-fous, zéro message qui dérape</h3>
        <p class="beat-body">
          Score shadow sur chaque draft. Alerte soft sur dérive douce.
          Blocage hard si une règle agence est violée. Aucun message
          ne sort sans avoir passé les filtres.
        </p>
      </li>
    </ul>

    <div class="hero-cta" id="cta">
      <a class="btn-primary" href="/demo">→ Essayez un clone en 5 min.</a>
      <div class="sub-ctas">
        <button type="button" class="demo-link mono" onclick={openDemo} disabled={demoLoading}>
          {demoLoading ? "chargement…" : "ou fouillez une démo pré-entraînée →"}
        </button>
  ...
  <section class="proof" aria-labelledby="proof-title">
    ...
    <h2 class="section-title" id="proof-title">
      Ce que votre setter voit, toute la journée.
    </h2>
    ...
    <div class="captures">
      <figure class="capture">
        ...
        <figcaption>
          ...
          Pas besoin que le clone devine la façon de votre client à partir de quelques posts.<br />
          Votre client écrit ses règles une fois. Le clone les exécute dès le 1er draft.
        </figcaption>
      </figure>
      ...
      <figure class="capture">
        ...
        <figcaption>
          ...
          Vous corrigez une fois. Vous expliquez une fois.<br />
  ...
  <section class="moat" aria-labelledby="moat-title">
    ...
    <h2 class="section-title" id="moat-title">
      Le process tient. Même quand votre équipe change.
    </h2>

    <div class="moat-body">
      <p class="moat-para">
        Setter senior qui part, junior qui arrive : même draft, même voix, même cadence.
        Le process du client ne vit plus dans la tête d'un humain. Il est écrit,
      ...
      <p class="moat-punch">
        Vos setters changent. Le process reste. Les corrections aussi.
      </p>
    </div>

    <div class="moat-cta">
      <a class="btn-primary" href="/demo">→ Essayez un clone en 5 min.</a>
      <a class="demo-link mono" href={DEMO_CTA_HREF}>ou rejoignez la waitlist →</a>
    </div>
  </section>
