...
export const SCENARIOS = [
  {
    ...
    metrics: [
      { name: "collapse", from: 82, to: 87 },
      { name: "ttr", from: 0.64, to: 0.71 },
      { name: "kurtosis", from: 2.1, to: 2.4 },
      { name: "ratio ?", from: 0.14, to: 0.18 },
    ],
  ...
  },
  {
    ...
    metrics: [
      { name: "collapse", from: 41, to: 78 },
      { name: "ttr", from: 0.48, to: 0.67 },
      { name: "kurtosis", from: 1.3, to: 2.2 },
      { name: "ratio ?", from: 0.03, to: 0.22 },
    ],
  ...
  },
  {
    ...
    metrics: [
      { name: "collapse", from: 55, to: 55 },
      { name: "ttr", from: 0.52, to: 0.52 },
      { name: "kurtosis", from: 1.6, to: 1.6 },
      { name: "ratio ?", from: 0.00, to: 0.00 },
    ],
