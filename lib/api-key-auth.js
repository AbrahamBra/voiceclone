...
//
// Rate-limit note (V1) : IP-based limiter in api/_rateLimit.js (20/min) is
// the only enforced cap for now. Per-key counters (10/min, 500/day from the
// plan) need a dedicated counter table — deferred to V3.6.6 ; in practice a
// single n8n / Breakcold instance hits the IP cap first.
// ============================================================
