...
export async function criticCheck(client, responseText, personaId) {
  ...
  const corrections = loadPersonaFile(personaId, "corrections.md");
...
export async function runPipeline({ systemPrompt, messages, sse, res, personaId }) {
  ...
  const verdict = await criticCheck(client, pass1Text, personaId);
