...
import { evaluateAgainstPersona } from "./critic/rhythmCritic.js";
...
export async function runPipeline({ systemPrompt, messages, sse, res, voiceRules, corrections, apiKey, model, personaId, conversationId, rhythmCtx, sources }) {
  ...
  // - Persist: renvoyé au caller (api/chat.js) qui l'appelle après insert message
  //   avec le vrai message_id. Persister ici le perdrait (message pas encore inséré).
  let criticResult = null;
  let criticDraft = null;
