...
const RE_BOOKS_SLOT = /\b(j'ai booké|c'est booké|c'est tout bon|(?:lundi|mardi|mercredi|jeudi|vendredi|samedi|dimanche)\s+\d{1,2}|(?:lundi|mardi|mercredi|jeudi|vendredi|samedi|dimanche)[^.?!]*\b(?:à|a)\s?\d{1,2}[h:]\d{0,2}?|le \d{1,2}[^.?!]*\b\d{1,2}[h:])\b/i;
