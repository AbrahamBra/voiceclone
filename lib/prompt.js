...
// Bumped again 1500 → 2200: hard_check rules average ~80-100 tokens each,
// not ~50, so 1500 only delivered ~18 rules in practice. 2200 fits ~25-28
// rules comfortably, covering the full hard+strong tier for Nicolas.
// Trade-off: 700 more tokens toward protocol, away from knowledge — acceptable
// since protocol rules are foundational and now priority-sorted by severity.
const PROTOCOL_TOKEN_BUDGET = 2200;
